...
This repository contains computer code (including Python notebooks), Machine Lerning Models and data files related to the prediction of functional LIR motifs and to the processing/analysis of biomedical texts for facilitating the curation of the (LIRcentral database)[https://lircentral.eu].
